              ...
              <div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 9XXXXXXXX</p>
                      <p className="text-gray-600">+91 8XXXXXXXX</p>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="#" className="bg-green-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-green-700 transition-colors">
                      <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
